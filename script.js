...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    console.log('Is chat container in the DOM:', document.body.contains(chatInterface.chatContainer));
    
    // Automatically show chat interface (for debugging)
    setTimeout(() => {
        console.log('Attempting to automatically show chat interface...');
        chatInterface.show();
        console.log('Chat interface has been automatically shown');
...
try {
    ...
    // Set the AI callback function for the chat interface
    if (chatInterface) {
            ...
            chatInterface.onMessageSend = async (message) => {
                ...
                setTimeout(() => {
                    ...
                    const fallbackResponses = [
                        ...
                        "My brain is still booting up, please give me a moment...",
                        "The system is updating, intelligent responses are temporarily unavailable."
                        ];
    ...
    if (chatToggleBtn) {
        chatToggleBtn.addEventListener('click', () => {
            if (chatInterface) {
                ...
                console.log('Chat interface visibility before click:', chatInterface.getVisibility());
                console.log('Chat container class name before click:', chatInterface.chatContainer.className);

                
                chatInterface.toggle();
                
                console.log('Chat interface visibility after click:', chatInterface.getVisibility());
    ...
    if (chatTestBtn) {
        chatTestBtn.addEventListener('click', () => {
            if (chatInterface) {
                ...
                "The chat interface is working properly, all functions are ready.",
